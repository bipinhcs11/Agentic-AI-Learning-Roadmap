...
public class JsonRpcHandler implements HttpHandler {
    ...
    private ContractDetails extractContractFromMessage(Map<String, Object> messageMap,
        ...
        for (Map<String, Object> partMap : parts) {
            ...
            if (partMap.containsKey("data")
                    && ("data".equals(kind) || kind == null || kind.isBlank())) {
    ...
    private Task buildCompletedTask(String taskId, RiskScore riskScore) {
        ...
        agentMessage.setContextId(taskId);
        agentMessage.setMessageId("msg-" + taskId);
        ...
        Artifact artifact = new Artifact(
                ...
                List.of(dataPart));
        artifact.setArtifactId("risk_score_result");
        artifact.setIndex(0);
    ...
    private Task buildErrorTask(String taskId, String errorMessage) {
        ...
        agentMessage.setContextId(taskId);
        agentMessage.setMessageId("error-msg-" + taskId);
        agentMessage.setTaskId(taskId);
        ...
        Task task = new Task(taskId, status, null);
        task.setContextId(taskId);
        task.setKind("task");
        return task;
    }
