...
- Phase 9 Dynamic Agentic RAG + MCP: 🔄 In Progress — new standalone MCP learning track before capstone integration.
  ...
  - Module 04 Java MCP Benefits Assistant: 🔄 In Progress — plain Java companion to Module 01 being built separately; keep it feature-aligned with the Python MCP basics module. Path: `Phase9_Dynamic_Agentic_RAG_MCP/module_04_java_mcp_benefits_assistant/`.
